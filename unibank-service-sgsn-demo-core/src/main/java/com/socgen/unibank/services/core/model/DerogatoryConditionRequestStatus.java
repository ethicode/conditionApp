...
public enum DerogatoryConditionRequestStatus {
    ...
    DerogatoryConditionRequestStatus(String label, boolean terminal) {
        this.label = label;
    ...
    public static DerogatoryConditionRequestStatus fromValue(String value) {
        if (value == null || value.isBlank()) {
            throw new IllegalArgumentException("Status cannot be null or blank");
        }
        for (DerogatoryConditionRequestStatus status : values()) {
